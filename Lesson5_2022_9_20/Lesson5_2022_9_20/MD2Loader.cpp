...
/** 初始化 */
void CMD2Loader::Init(const char *strFileName, const char *strTexture)
{
...
/** 载入MD2文件 */
bool CMD2Loader::ImportMD2(t3DModel *pModel, const char *strFileName, const char *strTexture)
{
